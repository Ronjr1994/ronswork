...
- Hero words and portrait are centered with no overlap.
- The positioning section shows only “Clear systems.” and “Useful digital work.”
- Hamburger changes into a visible X.
- All six navigation destinations fit on common phone heights.
- The desktop navbar and Ask Ron launcher are hidden while the menu is open.
- Contact contains no Built with attribution or AI/design-tool logos.
