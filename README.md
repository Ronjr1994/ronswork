...
## V33 button alignment and fit

- Centered labels vertically and horizontally across primary portfolio controls.
- Prevented button text from overflowing its division.
- Refined the Ask Ron launcher dimensions and text alignment.
- Kept Continue and Back aligned inside the project-brief footer.
- Improved assistant actions, form controls, contact CTAs, tool filters, and media actions across responsive widths.

### Compact Ask Ron launcher

- Reduced the floating launcher footprint on phones.
- Hid the secondary subtitle on mobile.
- Kept the label centered and fully inside its border.
- Added safe spacing from the viewport edges.
